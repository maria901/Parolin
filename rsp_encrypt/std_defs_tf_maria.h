...
/* require endian conversions for big-endian architectures          */
    ...
    //static u4byte *set_key_maria_v27(const u4byte in_key[], const u4byte key_len);

    //static void encrypt_maria_v27(const u4byte in_blk[4], u4byte out_blk[4]);

    //void decrypt_maria_v27(const u4byte in_blk[4], u4byte out_blk[4]);
