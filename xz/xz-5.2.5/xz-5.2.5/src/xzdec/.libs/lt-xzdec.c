...
/* ./.libs/lt-xzdec.c - temporary wrapper executable for .libs/xzdec
   Generated by libtool (GNU libtool) 2.4.6.42-b88ce-dirty

   The xzdec program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "xzdec"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# xzdec - temporary wrapper script for .libs/xzdec\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.42-b88ce-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The xzdec program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"xzdec:xzdec:$LINENO: libtool wrapper (GNU libtool) 2.4.6.42-b88ce-dir", f);
  fputs ("ty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"xzdec:xzdec:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"xzdec:xzdec:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
