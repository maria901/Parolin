...
/* ./.libs/lt-lzmainfo.c - temporary wrapper executable for .libs/lzmainfo
   Generated by libtool (GNU libtool) 2.4.6.42-b88ce-dirty

   The lzmainfo program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Ava/back/xz_sources_latest___ar/xz-5.2.5/src/liblzma/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Ava/back/xz_sources_latest___ar/xz-5.2.5/src/liblzma/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "lzmainfo"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.6.42-b88ce-dirty\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# lzmainfo - temporary wrapper script for .libs/lzmainfo\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.42-b88ce-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The lzmainfo program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  generated_by_libtool_version='2.4.6.42-b88ce-dirty'\n", f);
  fputs ("  notinst_deplibs=' ../../src/liblzma/liblzma.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"lzmainfo:lzmainfo:$LINENO: libtool wrapper (GNU libtool) 2.4.6.42-b88", f);
  fputs ("ce-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lzmainfo:lzmainfo:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lzmainfo:lzmainfo:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/Ava/back/xz_sources_latest___ar/xz-5.2.5/src/liblzma/.libs", f);
  fputs (":/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/Ava/back/xz_sources_latest___ar/xz-5.2.5/src/liblzma/.lib", f);
  fputs ("s:$PATH\"\n", f);
  fputs ("\n", f);
