...
/* ./.libs/lt-xz.c - temporary wrapper executable for .libs/xz
   Generated by libtool (GNU libtool) 2.4.6.42-b88ce-dirty

   The xz program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "xz"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# xz - temporary wrapper script for .libs/xz\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.42-b88ce-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The xz program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"xz:xz:$LINENO: libtool wrapper (GNU libtool) 2.4.6.42-b88ce-dirty\" 1>", f);
  fputs ("&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"xz:xz:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"xz:xz:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
