    ...
    bool &dataAfterEnd_Error)
{
  ...
  const UInt64 * const *outSizes2 = EncodeMode ? &mainCoder.PackSizePointers.Front() : &mainCoder.UnpackSizePointer;
	...
	/*
{
		char ric[300] =  "a passou ok coder.is1 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  ...
  if (mainCoder.Coder)
  {
	...
	/*
	{
		char ric[300] =  "a passou ok coder.is1.2 Coder\n";
		pedro_dprintf(-1, ric);
	}
	*/
  ...
  else
  {
	...
	/*
	{
		char ric[300] =  "a passou ok coder.is1.2 Coder2\n";
		pedro_dprintf(-1, ric);
	}
	*/
	...
	/*
{
		char ric[300] =  "a passou ok coder.is2 \n";
		pedro_dprintf(-1, ric);
	}
	*/
