...
#define MEU_AMANDA_S_SMART_APE_SIZE     ((((((1 << 17) / 1000 / 2)))))
#define MEU_AMANDA_S_SMART_APE_SIZE_v27 ((((((1 << 17) / 1000 / 2)))))
...
*/
        ...
        counter_amanda_s_smart_ape = MEU_AMANDA_S_SMART_APE_SIZE_v27 - 51 - 2;
