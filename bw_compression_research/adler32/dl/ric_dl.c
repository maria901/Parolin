...
you need to read the file, and make a copy of the file, in memory to avoid problems...
...
int main(__attribute__((unused)) int argc_ric, __attribute__((unused)) char **argv_ric)
{
