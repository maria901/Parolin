...
minha_struct.version_of_the_code = THE_CURRENT_amanda_COMPRESSOR_VERSION_FOR_THIS_RELEASE___; // v12 started 17 jan 2022 18:57
...
we have an idea of trying to compress 3 bytes in two using the standard lzss method of hanamandaing 4096
...
/*
     ...
     well, bit hanamandaing rountine was added, now what we will do is adapt a ls77 and lz77 together
...
hard work will be done..., variable buf_amanda_compressed holds the compressed stream, first we will focus on the compression, it need to compress, fast and well, then later we write the uncompressor
...
when working amanda_compressor will be part of the Parolin project, the extension will be .amanda
