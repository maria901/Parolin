...
#include "C:/AMANDA AVA KOCI PEREIRA/nosso_trabalho/amanda_projects/Jair_project_bwt_kp/ric_da_dua/bhond_research/ra_utilities.h"

int main()
{
    __attribute__((unused)) unsigned int ra___int_ret;

    // ra___int_ret = ra____mensaginha_sim_nao(L"vai");
    /*
        if (6 != ra___int_ret)
        {
            printf("Exiting my love...\n");
            return 7;
        }
    */
    ...
    if (main_dl_pure("make.bin", "./bhond_research/make.ari_original"))
    {
        printf("Meu amor, errinho...\n");
        return 7;
    }

    // 888888888888888888888888888888888888888888888888888888888888888888888888

    printf("size amor uncompress %d\n", ra____file_size_char("make.bin"));
    printf("size amor compressed %d\n", ra____file_size_char("./bhond_research/make.ari_original"));

    printf("Eu te amo ric\n");
    return 0;
}