...
bool cmdline_seat_verbose(__attribute__((unused)) Seat *seat)
{
    return cmdline_verbose();
}

bool cmdline_lp_verbose(__attribute__((unused)) LogPolicy *lp) { return cmdline_verbose(); }
