...
#define THE_COMPRESSOR_FUNCION_NAME_Z  compress_thread_7  /* the name of the compressor function */
/* (N)compress42.c - File compression ala IEEE Computer, Mar 1992. you read it correctly, Mar 1992, need more two years for win3.11
 *
 * Authors:
...
#ifdef HAS_UNCOMPRESS_Z
int decompress                      ARGS((FILE *, FILE *, my_thread_struct_z *));
#endif
