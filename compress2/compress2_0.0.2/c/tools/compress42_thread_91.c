...
#define THE_COMPRESSOR_FUNCION_NAME_Z  compress_thread_91    /* the name of the compressor function */
#define THE_DECOMPRESSOR_FUNCION_NAME_Z decompress_thread_91
