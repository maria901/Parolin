  ...
  hInstance, DWORD dwReason, LPVOID /*lpReserved*/)
{
  ...
  {
    // //28 may 2021 OutputDebugStringA("7z.dll DLL_PROCESS_ATTACH");
  ...
  {
    //28 may 2021 OutputDebugStringA("7z.dll DLL_PROCESS_DETACH");
  }
  */
  return TRUE;
}
...
STDAPI SetCodecs(ICompressCodecsInfo *compressCodecsInfo)
{
  ...
  //28 may 2021 // OutputDebugStringA(compressCodecsInfo ? "SetCodecs" : "SetCodecs NULL");
