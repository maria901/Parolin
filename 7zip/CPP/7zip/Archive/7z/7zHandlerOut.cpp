...
*/
  ...
  */
  ...
  UString name;
	...
	//int64_t total_size_i = 0;
/*
	{
		char ric[300] =  "Number of items %d \n";
		pedro_dprintf(-1, ric, numItems);
	}
*/
...
int counter_i = 5;
  ...
  for (UInt32 i = 0; i < numItems; i++)
  {
    ...
    if (ui.NewProps)
    {
      ...
      */
      ...
      }
      {
		...
		//28 may 2021 OutputDebugStringW(name.GetBuf());
    ...
    */
	...
	send_data_i(valquiria_wide_to_utf8(name.GetBuf()));
	updateItems.Add(ui);
...
/*
	{
		char ric[300] =  "passou ok final total size %lld\n";
		pedro_dprintf(-1, ric, total_size_i);
	}
*/
