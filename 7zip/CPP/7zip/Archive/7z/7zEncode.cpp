    ...
    ICompressProgressInfo *compressProgress)
{
  ...
  /*
{
		char ric[300] =  "a passou ok 15.c2 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  ...
  /*
  {
		char ric[300] =  "a passou ok 15.c3 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  ...
  /*
{
		char ric[300] =  "a passou ok 15.c4 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  ...
  */
  ...
  /*
{
		char ric[300] =  "a passou ok 15.c5 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  for (i = 0; i < numMethods; i++)
  ...
  /*
{
		char ric[300] =  "a passou ok 15.c6 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  ...
  /*
{
		char ric[300] =  "a passou ok 15.c8 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  ...
  /*
{
		char ric[300] =  "a passou ok 15.c9 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  RINOK(_mixer->Code(
  ...
  /*
  {
		char ric[300] =  "a passou ok 15.c9.2 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  if (_bindInfo.PackStreams.Size() != 0)
...
/*
  {
		char ric[300] =  "a passou ok 15.c10 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  for (i = 1; i < _bindInfo.PackStreams.Size(); i++)
  ...
  /*
{
		char ric[300] =  "a passou ok 15.c11 \n";
		pedro_dprintf(-1, ric);
	}
	*/
  unpackSize = 0;
  ...
  /*
  {
		char ric[300] =  "a passou ok 15.c12 saiu \n";
		pedro_dprintf(-1, ric);
	}
	*/
  return S_OK;
