...
extern bool * extract_pause__flag_i;
extern bool * extract_cancel_flag_i;
...
/*
	{
		char ric_[300] = "Entering...\n";
		pedro_dprintf(-1, ric_);
	}
*/
  ...
  for (;;)
  {
	...
	/*
	{
		char ric_[300] = "_inLim %lld _inBufSize %lld\n";
		pedro_dprintf(-1, ric_, (__int64) _inLim, (__int64) _inBufSize);
	}
	*/
...
slice_processed_i = _inProcessed;

	while(* extract_pause__flag_i)
	{
...
/*
	{
		char ric_[300] = "_inProcessed %lld _outProcessed %lld\n";
		pedro_dprintf(-1, ric_, (__int64) _inProcessed, (__int64) _outProcessed);
	}
*/
