...
extern long long int total_size_i;
    ...
    UInt64 &stdInProcessed)
{
  ...
  {
	char ricardo_[1027];
	strcpy(ricardo_, "Numitens de extract %d\n");
  ...
  */
  ...
  {
	char ricardo_[1027];
	strcpy(ricardo_, "Extract %d\n");
	pedro_dprintf(-1, ricardo_, 1);
  }
	*/
    ...
    CDecompressStat &st)
{
  ...
  {
	char ricardo_[1027];
	strcpy(ricardo_, "Dentro de Extract\n");
...
total_size_i = totalPackSize;

	/*
  {
	char ricardo_[1027];
	strcpy(ricardo_, "totalPackSize %lld i %d\n");
	pedro_dprintf(-1, ricardo_, (__int64) totalPackSize, i);
  }
	*/
