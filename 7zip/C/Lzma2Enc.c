...
int64_t total_size_i     ;
int64_t slice_processed_i;
...
slice_processed_i = p->srcPos;

//pedro_dprintf(-1, "posicao %lld\n", old_value_i + p->srcPos);
...
/*
{
		char ric[300] =  "a passou ok coder.is1.2 MT1 ok Coder\n";
		pedro_dprintf(-1, ric);
	}
	*/
