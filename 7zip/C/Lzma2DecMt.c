...
extern long long int slice_processed_i;
extern long long int old_value_i      ;
    ...
    )
{
  ...
  {
	char ricardo_[1027];
	strcpy(ricardo_, "progress 1 %lld\n");
	pedro_dprintf(-1, ricardo_, (__int64) p->inProcessed);
  }
  */
  slice_processed_i = 0;
  
  old_value_i += p->inProcessed;
  ...
  {
	char ricardo_[1027];
	strcpy(ricardo_, "progress 2 %lld\n");
	pedro_dprintf(-1, ricardo_, (__int64) p->inProcessed);
  }
  */
	slice_processed_i = p->inProcessed;
