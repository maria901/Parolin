    ...
    ELzmaFinishMode finishMode, ELzmaStatus *status)
{
	...
	//pedro_dprintf(-1, "LzmaDec_DecodeToDic %lld\n", (__int64) p->remainLen);
...
SRes LzmaDec_DecodeToBuf(CLzmaDec *p, Byte *dest, SizeT *destLen, const Byte *src, SizeT *srcLen, ELzmaFinishMode finishMode, ELzmaStatus *status)
{
  ...
  //pedro_dprintf(-1, "LzmaDec_DecodeToBuf \n");
  ...
  *srcLen = *destLen = 0;
  for (;;)
  {
	...
	//pedro_dprintf(-1, "Call from LzmaDec DecodeToBuf\n");
    ...
    ELzmaStatus *status, ISzAllocPtr alloc)
{
  ...
  //pedro_dprintf(-1, "LzmaDecode size in %lld\n", (__int64) *srcLen);
  ...
  *srcLen = inSize;
  ...
  //pedro_dprintf(-1, "Call from LzmaDecode in LzmaDec.c\n");
