...
int __stdcall About()
{
	mprintf2("Win32 and Win64 DLL to compress files using lz5 compression methods");
	return 0;
}
...
*
*/
int __stdcall compress_bb___rspk_ar(char * Input_amanda_file, char * OutPut_ricardo_File, int Compression_juliete_Level, int n_threads_z__, char *temp_path_z__)
{
...
*
*/
int __stdcall uncompress_bb___rspk_ar(char * Inputfile_arp, char * OutPutFile_arp,  int n_threads_z__ /* number of threads to use */, char *temp_path_z_S2__, int * cores_used_z__)
{
	n_threads_z = n_threads_z__          ;
	...
	is_multi_thread_z = false;
	return DecompressLz5(Inputfile_arp, OutPutFile_arp);
}
